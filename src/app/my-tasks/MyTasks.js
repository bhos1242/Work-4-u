        ...
        {userTasks.map((task) => (
          ...
          >
            ...
            <p className="mb-2 text-gray-600">
              <strong>Tasker Email:</strong> {task.taskerEmail}
            </p>
            <div
            ...
            <div className="flex buttons">
              ...
              <button
                className="px-4 py-1 mr-2 text-sm text-white transition duration-300 ease-in-out bg-green-500 rounded-full hover:bg-red-600"
                onClick={() => handleDeleteTask(task._id)}
              >
                {task.taskerEmail == "Not Assigned"
                  ? "Not Assined"
                  : "Tasker Profile"}
              </button>
              {!task.completed && (
