...
import logo from "./elements/work4u_new.png";
...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white shadow-md">
      <div className="container flex items-center justify-between px-6 py-4 mx-auto md:py-2 md:px-8 lg:px-12 lg:py-2">
        <Link href="/">
          <p className="text-3xl font-bold text-blue-600 cursor-pointer hover:text-blue-500">
            <Image src={logo} alt="Work4u" width={200} height={50} />
          </p>
        </Link>
